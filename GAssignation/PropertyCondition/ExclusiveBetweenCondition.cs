// -----------------------------------------------------------------------
// <copyright file="ExclusiveBetweenValidator.cs" company="Microsoft">
...
namespace GAssignation.PropertyCondition
{
    ...
    /// TODO: Update summary.
    /// </summary>
    public class ExclusiveBetweenCondition : AbstractRangeCondition
    {
		public ExclusiveBetweenCondition(IComparable from, IComparable to)
            : base(from, to)
        {
