// -----------------------------------------------------------------------
// <copyright file="InclusiveOutsideCondition.cs" company="Microsoft">
...
namespace GAssignation.PropertyCondition
{
    ...
    /// TODO: Update summary.
    /// </summary>
    public class InclusiveOutsideCondition : AbstractRangeCondition
    {
        public InclusiveOutsideCondition(IComparable from, IComparable to)
            : base(from, to)
        {
